...
export class Migration1749305442984 implements MigrationInterface {
    name = 'Migration1749305442984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tags" ADD "type" character varying(255)`);
